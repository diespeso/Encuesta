    ...
    class CRUD_quiz_has_questions
    {
        ...
        private void update(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "update Encuesta.quiz_has_questions set questionId='" + this.questionIdTextBox.Text + "',quizId='" + this.quizIdTextBox.Text + "';";
